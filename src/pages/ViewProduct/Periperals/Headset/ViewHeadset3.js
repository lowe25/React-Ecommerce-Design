...
import steelseriesHeadset from "assets/img/steelseriesHeadset.png";
function RyzenUnit1() {
  return (
    <ProductDetailsContainer>
      <ProductContainer>
        <ProductPicture>
          <img src={steelseriesHeadset} alt="Gaming Pc Pic" className="prod-img"></img>
        </ProductPicture>
        <ProductOrder>
          <label>
            <p>Steelseries Artic 3</p>
          </label>
          <label>
            <p>Price: $1,600</p>
          </label>
