...
import steelseriesMouse from "assets/img/steelseriesMouse.jpg";
function RyzenUnit1() {
  return (
    <ProductDetailsContainer>
      <ProductContainer>
        <ProductPicture>
          <img src={steelseriesMouse} alt="Gaming Pc Pic" className="prod-img"></img>
        </ProductPicture>
        <ProductOrder>
          <label>
            <p>Steelseries Sensei 310</p>
          </label>
          <label>
            <p>Price: $1,600</p>
          </label>
