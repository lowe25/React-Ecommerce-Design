import {
  ...
  import msiLaptop from "assets/img/msiLaptop.jpg";
  ...
  function ViewLaptop() {
    return (
      <ProductDetailsContainer>
        <ProductContainer>
          <ProductPicture>
            <img src={msiLaptop} alt="Gaming Pc Pic" className="prod-img"></img>
          </ProductPicture>
          <ProductOrder>
            <label>
              <p>MSI GE Series GE76 Raider</p>
            </label>
            <label>
              <p>Price: $1,600</p>
            </label>
        ...
        <ProductInfo>
          <table className="product-specs">
            ...
            <tr>
              <td>GPU:</td>
              <td>NVIDIA® GeForce RTX™ 3080 16GB GDDR6</td>
            </tr>
